...
export const useCountryCommentsStore = defineStore('countryGold', {
  state: () => ({
    // 存放CountryComment对象的数组，并添加一些默认值
    countryComments: [
      {
        id: 1,
